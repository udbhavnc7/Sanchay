...
class CustomerJourneyCardsProvider @Inject constructor(
  ...
  companion object {
    ...
    private fun voteCard() = CustomerJourneyCardModel(
      ...
      title = "How much are you willing to pay for Sanchay?",
      description = "We'd like to know if you will be interested to support Sanchay on a subscription basis so we can continue maintaining and developing the app.",
      cta = "Vote",
